...
test.describe('Authentication Tests', () => {
    ...
    test('Login with valid credentials', async ({ page, login, userData }) => {
    ...
    test('Login with locked-out user', async ({ page, login, userData }) => {
        ...
        test('Login with invalid credentials', async ({ page, login, userData }) => {
       ...
       test('Logout functionality', async ({ page, login, userData }) => {
    ...
    test('Session persistence on refresh', async ({ page, login, userData }) => {
